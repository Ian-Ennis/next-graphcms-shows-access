...
/* Added feature: UI allows user to choose sort order. 
    I queried the data through GraphQL, using getServerSideProps to call 
    the sorting methods that make their respective API calls below. 
    I'm still learning a couple of things about Next.js and GraphQL (first time using both), 
    and this was by brute-force-first approach to achieve functionality. There are likely DRYer, 
    more efficient ways to accomplish this with fewer requests to the server. Ideally I could 
    modify the "orderBy:" method dynamically within the original getAllShows() function. Currently 
    learning about other ways of accomplishing this. 
*/
